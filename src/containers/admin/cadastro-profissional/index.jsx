...
import { User, Mail, Lock, AlertCircle, ShieldCheck, ArrowLeft } from "lucide-react";
...
export default function CadastroProfissional() {
  ...
  const handleSubmit = async () => {
    if (!validate()) return;
    setLoading(true);
    const res = await createProfessional({ name: formData.nome, email: formData.email, password: formData.senha });
    setLoading(false);
    if (res.success) {
  ...
  return (
    <div style={{ maxWidth: 900, margin: "0 auto", padding: "4px 0 3rem" }}>
      ...
      {/* Breadcrumb */}
      <button
        onClick={() => navigate("/dashboard/admin/profissionais")}
        style={{
      ...
      >
        <ArrowLeft size={13} /> Voltar para Profissionais
      </button>
      ...
      <div style={{ marginBottom: 24, display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <div>
          ...
          <p style={{ fontSize: 13, color: FM.textMuted, margin: 0 }}>
            Área restrita — apenas administradores da empresa cadastram novas contas Professional
          </p>
        </div>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 16 }}>
        ...
        <div style={{
          ...
          <div>
            <Input
              icon={Lock} label="Senha provisória" name="senha" type="password"
        ...
        <div style={{
          ...
          background: `linear-gradient(145deg, #5a2ecc 0%, ${FM.purple} 55%, ${FM.purpleLight} 100%)`,
          ...
          <div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 20 }}>
              ...
              <div style={{ minWidth: 0 }}>
                <p style={{ fontSize: 16, fontWeight: 700, color: "#fff", margin: "0 0 2px", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                  {formData.nome || "Nome do profissional"}
                </p>
            ...
            <div style={{
              ...
              <ShieldCheck size={11} /> Role: Professional
            </div>
          </div>

          <p style={{ fontSize: 12, color: "rgba(255,255,255,0.65)", margin: 0, lineHeight: 1.5 }}>
            Essa conta poderá logar no site e no app com o e-mail e a senha definidos aqui,
            e passar a cadastrar e acompanhar seus próprios usuários.
          </p>
        </div>
      </div>
