  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/dashboard/pontos-interesse" element={<DashboardLayout><PontosInteresse /></DashboardLayout>} />
        <Route path="/dashboard/historico-sessoes" element={<DashboardLayout><HistoricoSessoes /></DashboardLayout>} />
        <Route path="/dashboard/sessao-detalhes/:id" element={<DashboardLayout><SessaoDetalhes /></DashboardLayout>} />
      </Routes>
    </Router>
  );
}
